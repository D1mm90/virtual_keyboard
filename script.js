  ...
  const content = `<div class="wrapper">
                        ...
                        <div class="keyboard">
                            <div class="first-row">
                                ...
                                <div class="key joykazino" id="Digit1">1</div>
                                <div class="key joykazino" id="Digit2">2</div>
                                <div class="key joykazino" id="Digit3">3</div>
                                <div class="key joykazino" id="Digit4">4</div>
                                <div class="key joykazino" id="Digit5">5</div>
                                <div class="key joykazino" id="Digit6">6</div>
                                <div class="key joykazino" id="Digit7">7</div>
                                <div class="key joykazino" id="Digit8">8</div>
                                <div class="key joykazino" id="Digit9">9</div>
                                <div class="key joykazino" id="Digit0">0</div>
...
const joykazinos = document.querySelectorAll('.digit');
...
function shiftSymbols() {
  const [one, two, three, four, five, six, seven, eight, nine, zero] = joykazinos;
